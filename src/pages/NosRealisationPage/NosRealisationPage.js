  ...
  return (
    <div>
      <HeroComponent
        ...
        describe="Chaque projet témoigne de notre engagement envers l’excellence, notre souci du détail et notre passion pour la création d’espaces inspirants. Explorez ci-dessous quelques-unes de nos réalisations."
        btnLink="#"
        btnName="Devis gratuit"
      />
      ...
      <Renovation
        title="Votre rénovation d'intérieur sur mesure commence ici."
        paragraph="Demandez un devis gratuit dès maintenant et parlons de votre projet."
      />
    </div>
  );
};
